...
public abstract class MoneyFactory {
	 ...
	 * subclass may override it to permit other parameter values. Throws:
	 * IllegalArgumentException if value of string is not a number.
	 * 
	 * @param value
	 *            of money that want to create
	 * @return money
	 */
